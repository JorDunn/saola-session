...
## [0.2.0](https://github.com/JorDunn/saola-session/compare/saola-session-v0.1.0...saola-session-v0.2.0) - 2026-09-07

### Changed

- *(config)* [**breaking**] read session.toml instead of session.kdl
